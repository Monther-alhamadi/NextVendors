...
class PostgresqlImpl(DefaultImpl):
    ...
    def _cleanup_index_expr(self, index: Index, expr: str, remove_suffix: str) -> str:
        # start = expr
        expr = expr.lower()
        expr = expr.replace('"', "")
        ...
        while isinstance(exp, UnaryExpression):
            if exp.modifier is None:
                ...
                if inner_op is None:
                    ...
                    if inner_op == operators.asc_op and op == operators.nullslast_op:
                        # default is asc nulls last
                        to_remove = " asc nulls last"
                    elif (
                        inner_op == operators.desc_op and op == operators.nullsfirst_op
                    ):
...
class CreateExcludeConstraintOp(ops.AddConstraintOp):
    ...
    def from_constraint(  # type:ignore[override]
        ...
        return cls(
            ...
            where=cast("Optional[Union[BinaryExpression, str]]", constraint.where),
